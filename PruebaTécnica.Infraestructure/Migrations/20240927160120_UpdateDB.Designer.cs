...
namespace PruebaTécnica.Infraestructure.Migrations
{
    ...
    [Migration("20240927160120_UpdateDB")]
            ...
            modelBuilder.Entity("PruebaTécnica.Domain.Cuenta.Account", b =>
                {
                    ...
                    b.OwnsOne("PruebaTécnica.Domain.Shared.Money", "Saldo", b1 =>
                        {
                            b1.Property<Guid>("AccountIdCuenta")
                                .HasColumnType("uuid")
                                .HasColumnName("id_cuenta");
                            ...
                            b1.HasKey("AccountIdCuenta");

                            b1.ToTable("account");

                            b1.WithOwner()
                                .HasForeignKey("AccountIdCuenta")
                                .HasConstraintName("fk_account_account_id_cuenta");
                        });
            ...
            modelBuilder.Entity("PruebaTécnica.Domain.Movimientos.Motion", b =>
                {
                    ...
                    b.OwnsOne("PruebaTécnica.Domain.Shared.Money", "Saldo", b1 =>
                        {
                            b1.Property<Guid>("MotionIdMovimiento")
                                .HasColumnType("uuid")
                                .HasColumnName("id_movimiento");
                            ...
                            b1.HasKey("MotionIdMovimiento");

                            b1.ToTable("motions");

                            b1.WithOwner()
                                .HasForeignKey("MotionIdMovimiento")
                                .HasConstraintName("fk_motions_motions_id_movimiento");
                        });
